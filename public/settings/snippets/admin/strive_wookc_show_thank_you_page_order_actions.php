<?php
	add_filter( 'woocommerce_order_actions', 'strive_wookc_show_thank_you_page_order_actions', 9999, 2 );
 	function strive_wookc_show_thank_you_page_order_actions( $actions, $order ) {
