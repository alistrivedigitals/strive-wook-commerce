<?php
	add_filter( 'woocommerce_checkout_fields' , 'strive_Wookc_display_checkbox_and_new_checkout_field' );
  	function strive_Wookc_display_checkbox_and_new_checkout_field( $fields ) {
    ...
    'clear'     => true
  	...
  	add_action( 'woocommerce_after_checkout_form', 'strive_wookc_conditionally_hide_show_new_field', 9999 );
  	function strive_wookc_conditionally_hide_show_new_field() {
    wc_enqueue_js( "
