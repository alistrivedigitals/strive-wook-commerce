<?php
    ...
    return $first_name;
 	...
 	add_filter( 'pre_user_last_name', 'strive_wookc_sync_user_edit_profile_edit_billing_last_name' );
 	function strive_wookc_sync_user_edit_profile_edit_billing_last_name( $last_name ) {
